			...
			<section class="breadcrumbs">
				<div class="container">
					<ul class="horizontal_list clearfix bc_list f_size_medium">
                        ...
                        <li><a href="city_1.php?city_id=<?=$city_id?>&city_item_id=1" class="default_t_color"><?=$city_name?> <i class="fa fa-angle-right d_inline_middle m_left_10 m_right_10"></i></a></li>
                        <li><a href="city_<?=$city_item_type?>.php?city_id=<?=$city_id?>&city_item_id=<?=$city_item_id?>" class="default_t_color"><?=$city_item_name?></a></li>
					</ul>
				</div>
			</section>
			<!--content-->
						...
						<section class="col-lg-9 col-md-9 col-sm-9">
                            <article class="m_bottom_15" style="">
                                <div class="row clearfix m_bottom_15">
                                    <div class="">
                                        <?php
                                            $results = $db->query("select * from article where id='$article_id'");
                                            $v = $results->fetchArray();
                                        ?>
                                        <h2 class="m_bottom_5 color_dark fw_medium m_xs_bottom_10" style="text-align: center;"><?=$v['title']?></h2>
